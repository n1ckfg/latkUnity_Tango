...
inline fixed4 BlurTex(sampler2D _tex, v2f_img input, half _stepSizeScale) {
		...
		#ifdef BLUR_RADIUS_3
		const half blurKernel[7] = {0.015625, 0.09375, 0.234375, 0.3125, 0.234375, 0.09375, 0.015625};
		#endif
		
		#ifdef BLUR_RADIUS_2
		const half blurKernel[5] = {0.0625, 0.25, 0.375, 0.25, 0.0625};
		#endif
		
		#ifdef BLUR_RADIUS_1
		const half blurKernel[3] = {0.25, 0.5, 0.25};
		#endif
	#endif
